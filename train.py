...
import argparse
from model.pytorch.supervisor import BGSLFSupervisor
...
parser.add_argument('--dataset_dir',default='data/PEMS04',type=str)
...
parser.add_argument('--feas_dim',type=int)
...
if __name__ == '__main__':
    print('************************SSU************************')
    supervisor = BGSLFSupervisor(args=args)
